...
double_jump_flag	= $1F ; set if player has already doublejumped
fly_timer	=	$20 ; and $21 ; counts down from 10s * 60 frames = 600 frames if Tails is in the air, flying
...
; ---------------------------------------------------------------------------
; title prompt object properties:
tp_timer = objoff_3A
...
; title screen object status bits
staFinished:		equ 0 ; cleared by the init process. set when the title animation is finished
staFlash:			equ 1 ; cleared by the init process. set when the title animation is finished, cleared on title screen
maskFinished:		equ 1<<staFinished	; $01
maskFlash:			equ 1<<staFlash		; $02
...
GameModeID_CharaSelect =		id(GameMode_CharaSelect) ; 18
...
GameModeID_MainMenu =	id(GameMode_MainMenu) ; 2C
GameModeID_CreditsScreen =	id(GameMode_CreditsScreen) ; 30
...
PalID_Title2 =	id(PalPtr_Title2) ; 2
PalID_MainMenu =	id(PalPtr_MainMenu) ; 3
PalID_BGND =	id(PalPtr_BGND) ; 4
PalID_EHZ =	id(PalPtr_EHZ) ; 5
PalID_EHZ2 =	id(PalPtr_EHZ2) ; 6
PalID_WZ =	id(PalPtr_WZ) ; 7
PalID_EHZ3 =	id(PalPtr_EHZ3) ; 8
PalID_MTZ =	id(PalPtr_MTZ) ; 9
PalID_MTZ2 =	id(PalPtr_MTZ2) ; A
PalID_WFZ =	id(PalPtr_WFZ) ; B
PalID_HTZ =	id(PalPtr_HTZ) ; C
PalID_HPZ =	id(PalPtr_HPZ) ; D
PalID_EHZ4 =	id(PalPtr_EHZ4) ; E
PalID_OOZ =	id(PalPtr_OOZ) ; F
PalID_MCZ =	id(PalPtr_MCZ) ; 10
PalID_CNZ =	id(PalPtr_CNZ) ; 11
PalID_CPZ =	id(PalPtr_CPZ) ; 12
PalID_DEZ =	id(PalPtr_DEZ) ; 13
PalID_ARZ =	id(PalPtr_ARZ) ; 14
PalID_SCZ =	id(PalPtr_SCZ) ; 15
PalID_HPZ_U =	id(PalPtr_HPZ_U) ; 16
PalID_CPZ_U =	id(PalPtr_CPZ_U) ; 17
PalID_ARZ_U =	id(PalPtr_ARZ_U) ; 18
PalID_SS =	id(PalPtr_SS) ; 19
PalID_MCZ_B =	id(PalPtr_MCZ_B) ; 1A
PalID_CNZ_B =	id(PalPtr_CNZ_B) ; 1B
PalID_SS1 =	id(PalPtr_SS1) ; 1C
PalID_SS2 =	id(PalPtr_SS2) ; 1D
PalID_SS3 =	id(PalPtr_SS3) ; 1E
PalID_SS4 =	id(PalPtr_SS4) ; 1F
PalID_SS5 =	id(PalPtr_SS5) ; 20
PalID_SS6 =	id(PalPtr_SS6) ; 21
PalID_SS7 =	id(PalPtr_SS7) ; 22
PalID_SS1_2p =	id(PalPtr_SS1_2p) ; 23
PalID_SS2_2p =	id(PalPtr_SS2_2p) ; 24
PalID_SS3_2p =	id(PalPtr_SS3_2p) ; 25
PalID_OOZ_B =	id(PalPtr_OOZ_B) ; 26
PalID_Menu =	id(PalPtr_Menu) ; 27
PalID_Result =	id(PalPtr_Result) ; 28
PalID_Credits =	id(PalPtr_Credits) ; 29
PalID_CharaSelect	= id(PalPtr_CharaSelect) ; 2A
...
ObjID_RingCursor =		id(ObjPtr_RingCursor)		; 0C
ObjID_Signpost =		id(ObjPtr_Signpost)		; 0D
ObjID_TitleIntro =		id(ObjPtr_TitleIntro)		; 0E
ObjID_TitlePrompt =		id(ObjPtr_TitlePrompt)		; 0F
...
ObjID_BoingOBot =		id(ObjPtr_Coconuts)		; 9D
...
SndID_TitleBounce =	id(SndPtr_TitleBounce)		; D2
...
CharaSelectPalID:	ds.b	1
CharaSelectPalMode:	ds.b	1
CharaSelectPalTimer:	ds.b	1
...
HorizontalScrollBuffer struct dots
	ds.l	240	; Total lines on the screen.
...
Region_backup:	ds.b	1

				ds.b	2	; $FFFFFE14-$FFFFFE15 ; seems unused
...
SS2p_RingBuffer:		ds.w	6
				ds.b	2	; $FFFFFFAC-$FFFFFFAF ; seems unused
Got_Emerald:			ds.b	1
...
Vertical_scroll_mirror:		ds.l	1

Menu_selection:		ds.b	1
...
Options_Hint_counter_to_yellow:	ds.b	1

Options_current_option:			ds.b	1
Options_switch_game_mode:		ds.b	1 ; for opts menu
...
VRAM_Horiz_Scroll_Table_Size             = 240*2*2	; 240 lines * 2 bytes per entry * 2 PNTs
